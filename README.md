...
Each row number in both heatmaps represent its "add to cart" order rank in relation to the other 11 products in the cart-how much the item in the beggining changes later-bought products.  
